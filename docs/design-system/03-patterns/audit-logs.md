...
## Purpose
Immutable history for security/compliance confidence.
...
## Layout anatomy
Dense table · date filters · detail drawer

## Token usage
Compact table density · mono for IDs
...
## Don’t
Don’t allow inline edit of audit rows.
