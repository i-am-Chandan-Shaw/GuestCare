...
## Purpose
Selectable or dismissible compact choice.
...
| Hover | surface-hover |
| Pressed | primary-soft when selected |
...
## Figma notes
Variables from Color/Spacing/Radius/Elevation. Set: `Chip`.
